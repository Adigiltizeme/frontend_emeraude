  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '3rem 1rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
        <h1 style={{ color: 'var(--color-primary-900)' }}>Mon Espace Investisseur</h1>
        <button onClick={() => { logout(); navigate('/'); }} className="btn btn-outline">Se déconnecter</button>
      </div>
      ...
      <div style={{ backgroundColor: 'var(--color-white)', padding: '2rem', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-sm)', marginBottom: '3rem' }}>
        <h2 style={{ color: 'var(--color-primary-800)', marginBottom: '1rem', fontSize: '1.5rem' }}>Bonjour, {user.firstName || user.email} 👋</h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
        <div style={{ backgroundColor: 'var(--color-white)', padding: '2rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-neutral-200)' }}>
          ...
          <h3 style={{ color: 'var(--color-neutral-800)', marginBottom: '0.5rem' }}>Mes Investissements</h3>
        ...
        <div style={{ backgroundColor: 'var(--color-white)', padding: '2rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-neutral-200)', opacity: 0.7 }}>
          ...
          <h3 style={{ color: 'var(--color-neutral-800)', marginBottom: '0.5rem' }}>Mes Documents</h3>
        ...
        <div style={{ backgroundColor: 'var(--color-white)', padding: '2rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-neutral-200)', opacity: 0.7 }}>
          <Settings size={32} color="var(--color-neutral-400)" style={{ marginBottom: '1rem' }} />
          <h3 style={{ color: 'var(--color-neutral-800)', marginBottom: '0.5rem' }}>Mon Profil</h3>
