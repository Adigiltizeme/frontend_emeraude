...
const EditProject = () => {
  ...
  return (
    <div style={{ padding: '3rem 2rem', maxWidth: '900px', margin: '0 auto', backgroundColor: 'var(--color-neutral-100)', minHeight: '100vh' }}>
      ...
      <form onSubmit={handleUpdate} style={{ backgroundColor: 'var(--color-white)', padding: '3rem', borderRadius: 'var(--radius-lg)', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
          <button type="submit" disabled={loading} className="btn btn-primary" style={{ flex: 1, padding: '1rem', fontSize: '1.1rem', fontWeight: 'bold', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem' }}>
            {loading ? t('admin.projectForm.btnUpdating') : t('admin.projectForm.btnUpdate')}
          </button>
